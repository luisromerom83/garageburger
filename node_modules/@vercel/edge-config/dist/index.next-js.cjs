"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/index.next-js.ts
...
var edgeConfigTraceSymbol = /* @__PURE__ */ Symbol.for("@vercel/edge-config:global-trace");
      ...
      const api = {
        get: trace(
          async function get2(key, localOptions) {
            ...
            if (_optionalChain([localOptions, 'optionalAccess', _3 => _3.consistentRead])) {
            ...
            return fetchEdgeConfigItem2(
              ...
              key,
              version2,
              _optionalChain([localOptions, 'optionalAccess', _4 => _4.consistentRead]),
              headers,
              fetchCache
            );
          },
        ...
        has: trace(
          async function has2(key, localOptions) {
            ...
            let localEdgeConfig = null;
            if (_optionalChain([localOptions, 'optionalAccess', _5 => _5.consistentRead])) {
            } else if (shouldUseDevelopmentCache) {
              localEdgeConfig = await getInMemoryEdgeConfig2(
                connectionString,
                fetchCache,
            ...
            return fetchEdgeConfigHas2(
              ...
              key,
              version2,
              _optionalChain([localOptions, 'optionalAccess', _6 => _6.consistentRead]),
              headers,
              fetchCache
            );
          },
        ...
        getAll: trace(
          async function getAll2(keys, localOptions) {
            ...
            let localEdgeConfig = null;
            if (_optionalChain([localOptions, 'optionalAccess', _7 => _7.consistentRead])) {
            } else if (shouldUseDevelopmentCache) {
              localEdgeConfig = await getInMemoryEdgeConfig2(
                connectionString,
                fetchCache,
            ...
            return fetchAllEdgeConfigItem2(
              ...
              keys,
              version2,
              _optionalChain([localOptions, 'optionalAccess', _8 => _8.consistentRead]),
              headers,
              fetchCache
            );
          },
        ...
        digest: trace(
          async function digest2(localOptions) {
            let localEdgeConfig = null;
            if (_optionalChain([localOptions, 'optionalAccess', _9 => _9.consistentRead])) {
            } else if (shouldUseDevelopmentCache) {
              localEdgeConfig = await getInMemoryEdgeConfig2(
                connectionString,
                fetchCache,
            ...
            return fetchEdgeConfigTrace2(
              baseUrl,
              version2,
              _optionalChain([localOptions, 'optionalAccess', _10 => _10.consistentRead]),
              headers,
              fetchCache
            );
          },
...
// src/edge-config.ts
var _globalconfigfs = require('@vercel/global-config-fs');
...
function extractStaleIfError(cacheControlHeader) {
  ...
  return _optionalChain([matched, 'optionalAccess', _11 => _11.groups]) ? Number(matched.groups.staleIfError) : null;
}
...
var readFileTraced = trace(_globalconfigfs.readFile, { name: "readFile" });
var jsonParseTraced = trace(JSON.parse, { name: "JSON.parse" });
var privateEdgeConfigSymbol = /* @__PURE__ */ Symbol.for("privateEdgeConfig");
